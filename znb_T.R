...
save(T_est_modelset, file = "./rda/T_est_modelset.rda", compress = TRUE)
save(T_est_valset, file = "./rda/T_est_valset.rda", compress = TRUE)

q(save = "no")


#shell script: echo R CMD BATCH znb_T.R | qsub -N znb_T -cwd -l mf=5G,h_vmem=5G
