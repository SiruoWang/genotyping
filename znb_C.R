...
save(C_est_modelset, file = "./rda/C_est_modelset.rda", compress = TRUE)
save(C_est_valset, file = "./rda/C_est_valset.rda", compress = TRUE)

q(save = "no")

#shell script: echo R CMD BATCH znb_C.R | qsub -N znb_C -cwd -l mf=5G,h_vmem=5G
