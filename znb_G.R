...
save(G_est_modelset, file = "./rda/G_est_modelset.rda", compress = TRUE)
save(G_est_valset, file = "./rda/G_est_valset.rda", compress = TRUE)

q(save = "no")


#shell script: echo R CMD BATCH znb_G.R | qsub -N znb_G -cwd -l mf=5G,h_vmem=5G
